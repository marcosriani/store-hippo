...
const perks = [
  {
    ...
    description:
      'Get your assets delivered to your email in seconds and download it right away.',
  },
  {
  ...
  },
  {
    ...
    Icon: Leaf,
    description:
      "We've pledged 1% of sales to the preservation and restoration of the national environment",
  },
];
